    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="py-12 bg-bzr-bg-blue">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-bzr-dark-blue mb-4">Контакты</h1>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Свяжитесь с нами для получения консультации или дополнительной информации о наших услугах
              </p>
            </div>
                      ...
                      <CardHeader>
                        <div className="flex items-center mb-2">
                          <span className="inline-flex items-center justify-center bg-bzr-bg-blue w-10 h-10 rounded-full mr-4">
                            <Icon name="User" className="h-5 w-5 text-bzr-blue" />
                          </span>
                          <div>
                      ...
                      <CardContent>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center">
                            <Icon name="Phone" className="h-4 w-4 mr-2 text-bzr-blue" />
                            <span>{person.phone}</span>
                          </div>
                          <div className="flex items-center">
                            <Icon name="Mail" className="h-4 w-4 mr-2 text-bzr-blue" />
                            <span>{person.email}</span>
                          </div>
                        </div>
                      </CardContent>
                      <CardFooter>
                        <Button variant="outline" className="w-full border-bzr-blue text-bzr-blue hover:bg-bzr-blue hover:text-white">
                  ...
                  {branches.map((branch, index) => (
                    <Card key={index} className="h-full">
                      <CardHeader>
                        <div className="flex items-center mb-2">
                          <span className="inline-flex items-center justify-center bg-bzr-bg-blue w-10 h-10 rounded-full mr-4">
                            <Icon name="Building" className="h-5 w-5 text-bzr-blue" />
                          </span>
                          <div>
                            <CardTitle className="text-lg">БЗР Банк в г. {branch.city}</CardTitle>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-2 mb-4">
                          <div className="flex items-start">
                            <Icon name="MapPin" className="h-4 w-4 mr-2 mt-1 text-bzr-blue" />
                          ...
                          <div className="flex items-center">
                            <Icon name="Clock" className="h-4 w-4 mr-2 text-bzr-blue" />
              ...
              <TabsContent value="feedback">
                <Card className="max-w-2xl mx-auto">
                  <CardHeader>
                    ...
                    <CardDescription>Заполните форму, и наши специалисты свяжутся с вами в ближайшее время</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <label htmlFor="topic" className="block text-sm font-medium text-gray-700">Тема обращения</label>
                          <select
                            id="topic"
                            className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-bzr-blue"
                          >
                      ...
                      <div className="flex items-start">
                        ...
                        <label htmlFor="agree" className="text-sm text-gray-600">
                          Я согласен на обработку персональных данных в соответствии с <a href="/privacy" className="text-bzr-blue hover:underline">политикой конфиденциальности</a>
                        </label>
                      </div>
                    </form>
                  </CardContent>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-bzr-dark-blue mb-4">Свяжитесь с нами</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                У вас есть вопросы или предложения? Воспользуйтесь одним из способов связи ниже
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="text-center">
                ...
                <CardContent>
                  ...
                  <a href="tel:88005553535" className="text-bzr-blue font-semibold text-lg hover:underline">
                    8 (800) 555-35-35
                  </a>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  ...
                  <a href="mailto:info@bzrbank.ru" className="text-bzr-blue font-semibold text-lg hover:underline">
                    info@bzrbank.ru
                  </a>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardHeader className="pb-2">
                  <div className="w-16 h-16 bg-bzr-bg-blue rounded-full flex items-center justify-center mx-auto">
                    <Icon name="MessageSquare" className="h-8 w-8 text-bzr-blue" />
                  </div>
                </CardHeader>
                <CardContent>
