        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-bzr-dark-blue font-montserrat font-bold text-xl">
                БЗР Банк
              </span>
              <span className="text-bzr-blue text-xs">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className="text-gray-700 hover:text-bzr-blue font-medium transition-colors"
            >
              Главная
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button
              variant="outline"
              className="border-bzr-blue text-bzr-blue hover:bg-bzr-blue hover:text-white"
            >
